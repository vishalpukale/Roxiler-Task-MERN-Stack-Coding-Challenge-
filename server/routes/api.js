...
router.get('/bar-chart', async (req, res) => {
    try {
        ...
        const response = data.reduce((acc, curr) => {
            ...
            // calculation for price range such that all values <= priceRange && > priceRange-100
...
// get api to fetche the data from all the 3 APIs, and sends a final response of JSON
